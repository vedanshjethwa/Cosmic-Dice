  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl lg:text-2xl font-bold text-white">Affiliate Program</h2>
      </div>
      ...
      <div className="bg-[#1A243D] rounded-xl border border-blue-500/20 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-base lg:text-lg font-semibold text-white">About Our Program</h3>
          </div>
          {isExpanded ? (
        ...
        {isExpanded && (
          <div className="px-4 lg:px-6 pb-4 lg:pb-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-gray-400 space-y-2 text-sm lg:text-base">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-[#1A243D] rounded-xl p-4 lg:p-6 border border-blue-500/20">
          ...
          <p className="text-xl lg:text-2xl font-bold text-white">24</p>
        </div>
        <div className="bg-[#1A243D] rounded-xl p-4 lg:p-6 border border-blue-500/20">
          <h3 className="text-gray-400 mb-2">Total Earnings</h3>
          <p className="text-xl lg:text-2xl font-bold text-green-400">$1,250.00</p>
        </div>
      </div>
    </div>
  );
