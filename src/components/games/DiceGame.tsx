    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="flex-1 space-y-3 md:space-y-6 max-w-lg mx-auto w-full">
            <div className="space-y-3 md:space-y-6">
              ...
              <div className="space-y-1 md:space-y-2">
                ...
                <div className="flex gap-1.5 md:gap-2 items-center">
                  <button
                    ...
                    className="bg-gray-800 hover:bg-gray-700 border border-gray-700 p-2 md:p-3 transition-colors"
                    title="Half Bet"
                    disabled={isRolling}
                  >
                  ...
                  <input
                    ...
                    className="bg-gray-800 border border-gray-700 px-3 py-2 md:px-4 md:py-3 w-full text-base md:text-lg focus:outline-none focus:border-blue-500 transition-colors"
                ...
                <div className="grid grid-cols-3 md:flex gap-2 md:gap-6 justify-center py-2 md:py-6">
                  {[1, 2, 3, 4, 5, 6].map((dice) => (
                    <button
                      ...
                      disabled={isRolling}
                      className={`w-10 h-10 md:w-14 md:h-14 bg-gray-800 border border-gray-700 flex items-center justify-center transition-all ${
                        selectedDice === dice
                          ? 'ring-2 ring-blue-500 shadow-lg shadow-blue-500/20 scale-110'
                          : !isRolling ? 'hover:bg-gray-700 hover:scale-105' : 'opacity-50'
                      }`}
                    >
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 md:py-4 transition-colors text-base md:text-lg relative group"
              >
        ...
        <div className="mt-4 bg-gray-800 p-6 border border-gray-700">
          <h2 className="text-xl font-bold mb-4 text-blue-400">Recent Bets</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {betHistory.slice(-6).reverse().map((bet, index) => (
              <div 
                key={index}
                className={`p-4 ${bet.isWin ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'}`}
              >
