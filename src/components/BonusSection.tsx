    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <h1 className="text-3xl font-bold text-white">Active Bonuses</h1>
        </div>
      ...
      <div className="bg-[#1A243D] rounded-xl p-6 border border-blue-500/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <button className="bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 px-6 py-2 rounded-lg transition-colors border border-blue-500/20">
              Get Rakeback
            </button>
          </div>
          <div>
