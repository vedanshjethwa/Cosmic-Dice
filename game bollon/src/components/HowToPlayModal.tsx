...
export function HowToPlayModal({ isOpen, onClose }: HowToPlayModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl max-w-md w-full p-6 border border-blue-500/20 relative">
        ...
        <div className="space-y-4 text-gray-300">
          <div className="flex items-start gap-3">
            ...
            <p>Set your bet amount using the + and - buttons or type it directly (up to your balance)</p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <p>Your winnings will be your bet amount × the revealed multiplier</p>
          </div>
          ...
          <div className="mt-4 p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
            ...
            <p className="text-sm text-gray-400">The bet increment changes automatically:
